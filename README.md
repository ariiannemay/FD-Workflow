...
A specialized Discord bot designed to streamline operations for remote editing teams. This tool automates the **First-In-First-Out (FIFO)** assignment queue, calculates strict Turnaround Times (TAT), and manages communication between Coordinators and Editors.
